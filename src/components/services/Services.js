            ...
            <div className="col-lg-6 col-md-6 col-12 p-5">
              <div className="service card card-body" id="rightCard">
                ...
                <div className={serviceStyle.text}>
                  ...
                  <strong className={"h5"}>développer votre activité</strong>,
                  augmenter votre{" "}
                  <strong className={"h5"}>chiffre d'affaires</strong>,
                  développer ou <strong className={"h5"}>optimiser</strong> un
                  site ou <strong className={"h5"}>une application</strong>. Je
                  peux <strong className={"h5"}>prendre en charge</strong> votre
                  projet <strong className={"h5"}>du développement</strong>{" "}
                  jusqu’au plan marketing et
                  <strong> au lancement</strong>. N’hésitez pas à{" "}
            ...
            <div className="col-lg-6 col-md-4 col-12 m-auto">
              <div className={serviceStyle.services}>
                ...
                <div className={serviceStyle.card}>
                  ...
                  un appareil électronique mobile, tel qu'un assistant
                  personnel, un téléphone portable, un smartphone, un baladeur
                  numérique, une tablette tactile, ou encore certains
                  ordinateurs fonctionnant avec le système d'exploitation
                ...
                <div className={serviceStyle.card}>
                  ...
                  copywriting est l'acte d'écrire du texte afin de pousser le
                  lecteur à passer l'action. Un achat, un abonnement, une
                  inscription, toutes les actions que vous souhaitez mettre en
                  place peuvent être optimisées et générer, par l'écriture d'une
                  page de vente, d'un email commercial, d'une newsletter, des
                  résultats bien au-delà de vos espérances. C'est encore
                  aujourd'hui l'outil marketing le pluis puissant, quand-il est
                  fait correctement bien sûr.
                </div>
                <div className={serviceStyle.card}>
                  <h3 className={serviceStyle.titleCard}>
                    marketing de contenus et de réseau
                  </h3>
                  <span className={serviceStyle.firstLetter}>L</span>e marketing
                  des médias sociaux peut vous aider à bâtir un réseau rempli de
                  clients ou d'acheteurs potentiels qui s'intéressent à votre
                  entreprise et ce que vous avez à offrir. Ces groupes
                  d'acheteurs ou de clients potentiels consultent leurs comptes
                  sociaux 4 à 10 fois par jour.
                </div>
              </div>
            </div>
          </div>
